...
export const STYLE_PROFILES: Record<StyleId, StyleProfile> = {
  ...
  bach: {
    ...
    priors: {
      ...
      register: { mid: 90, high: 10 },
      motion: { walking: 25, flowing: 15, florid: 60 },
      accompaniment: { sustained: 15, broken: 20, stride: 10, counterline: 55 },
    ...
    variants: [
      // Preludes in unbroken figuration (WTC I/1, I/2).
      {
        ...
        priors: {
          ...
          register: { mid: 100 },
          motion: { florid: 100 },
          accompaniment: { broken: 55, counterline: 45 },
      ...
      // Sarabandes and arias: slow triple time, ornamented line over a walking bass.
      {
        ...
        priors: {
          ...
          register: { mid: 85, high: 15 },
          motion: { walking: 30, flowing: 70 },
          accompaniment: { sustained: 15, stride: 15, counterline: 70 },
      ...
      // Gigues, minuets, correntes.
      {
        ...
        priors: {
          ...
          register: { mid: 65, high: 35 },
          motion: { walking: 35, flowing: 25, florid: 40 },
      ...
      // Minor-key toccatas.
      {
        ...
        priors: {
          ...
          register: { mid: 100 },
          motion: { walking: 10, florid: 90 },
          accompaniment: { pulse: 10, counterline: 90 },
  ...
  beethoven: {
    ...
    priors: {
      ...
      register: { mid: 62, high: 38 },
      motion: { sustained: 12, walking: 44, flowing: 44 },
      accompaniment: { sustained: 8, broken: 30, pulse: 44, stride: 12, counterline: 6 },
    ...
    variants: [
      // Pathétique / Tempest / Appassionata allegros.
      {
        ...
        priors: {
          ...
          motion: { sustained: 15, walking: 35, flowing: 40, florid: 10 },
          accompaniment: { pulse: 90, counterline: 10 },
      ...
      // Adagio cantabile: a hymn-like tune over a murmuring accompaniment.
      {
        ...
        priors: {
          ...
          accompaniment: { sustained: 20, broken: 60, counterline: 20 },
      ...
      // Op. 27/2, first movement.
      {
        ...
        priors: {
          ...
          motion: { walking: 20, flowing: 80 },
          accompaniment: { sustained: 20, broken: 80 },
      ...
      // Waldstein, Eroica, Emperor.
      {
        ...
        priors: {
          ...
          register: { mid: 85, high: 15 },
          motion: { sustained: 35, walking: 50, flowing: 15 },
          accompaniment: { broken: 20, pulse: 65, stride: 15 },
      ...
      // Scherzos and bagatelles.
      {
        ...
        priors: {
          ...
          register: { mid: 25, high: 75 },
          motion: { walking: 40, flowing: 60 },
          accompaniment: { broken: 25, stride: 75 },
      ...
      // Funeral marches; the Seventh Symphony's Allegretto ostinato.
      {
        ...
        priors: {
          ...
          register: { mid: 100 },
          motion: { sustained: 40, walking: 60 },
          accompaniment: { sustained: 35, pulse: 65 },
  ...
  chopin: {
    ...
    priors: {
      ...
      register: { low: 14, mid: 42, high: 44 },
      motion: { walking: 58, flowing: 30, florid: 12 },
      accompaniment: { sustained: 14, broken: 60, pulse: 12, stride: 14 },
    ...
    variants: [
      // Nocturnes: singing cantabile over rolling left-hand figuration.
      {
        ...
        priors: {
          ...
          register: { low: 15, mid: 25, high: 60 },
          motion: { walking: 40, flowing: 60 },
          accompaniment: { sustained: 15, broken: 85 },
      ...
      // Mazurkas and waltzes.
      {
        ...
        priors: {
          ...
          register: { low: 15, mid: 25, high: 60 },
          motion: { walking: 90, flowing: 10 },
          accompaniment: { sustained: 15, broken: 35, stride: 50 },
      ...
      // Ballades and scherzos.
      {
        ...
        priors: {
          ...
          register: { mid: 60, high: 40 },
          motion: { walking: 40, flowing: 40, florid: 20 },
          accompaniment: { broken: 45, pulse: 55 },
      ...
      // Études: unbroken figuration.
      {
        ...
        priors: {
          ...
          register: { mid: 75, high: 25 },
          motion: { walking: 15, flowing: 25, florid: 60 },
      ...
      // Slow preludes and spare late nocturnes.
      {
        ...
        priors: {
          ...
          register: { low: 40, mid: 15, high: 45 },
          motion: { sustained: 10, walking: 45, flowing: 45 },
          accompaniment: { sustained: 45, broken: 45, pulse: 10 },
  ...
  debussy: {
    ...
    priors: {
      ...
      register: { low: 40, mid: 10, high: 50 },
      motion: { sustained: 45, walking: 20, flowing: 25, florid: 10 },
      accompaniment: { sustained: 45, broken: 30, pulse: 15, stride: 5, counterline: 5 },
    ...
    variants: [
      {
        ...
        priors: {
          ...
          register: { low: 40, high: 60 },
          motion: { sustained: 55, walking: 20, flowing: 25 },
          accompaniment: { sustained: 55, broken: 25, pulse: 20 },
      ...
      // Arabesque, Jardins sous la pluie, Doctor Gradus.
      {
        ...
        priors: {
          ...
          motion: { flowing: 55, florid: 45 },
          accompaniment: { broken: 80, counterline: 20 },
      ...
      // Des pas sur la neige, La cathédrale engloutie.
      {
        ...
        priors: {
          ...
          register: { low: 80, high: 20 },
          motion: { sustained: 100 },
          accompaniment: { sustained: 60, pulse: 40 },
      ...
      // La fille aux cheveux de lin, Rêverie.
      {
        ...
        priors: {
          ...
          register: { low: 70, mid: 10, high: 20 },
          motion: { sustained: 45, walking: 35, flowing: 20 },
          accompaniment: { sustained: 45, broken: 20, pulse: 35 },
      ...
      // Golliwogg's Cakewalk, Minstrels.
      {
        ...
        priors: {
          ...
          register: { high: 100 },
          motion: { walking: 50, flowing: 50 },
          accompaniment: { stride: 100 },
  ...
  hans_zimmer: {
    ...
    priors: {
      ...
      register: { low: 28, mid: 56, high: 16 },
      motion: { sustained: 50, walking: 24, flowing: 26 },
      accompaniment: { sustained: 8, broken: 16, pulse: 76 },
    ...
    variants: [
      // Layered ostinato that thickens without becoming a cell-process étude.
      {
        ...
        priors: {
          ...
          motion: { sustained: 65, flowing: 35 },
          accompaniment: { broken: 15, pulse: 85 },
      ...
      // Warm major anthems.
      {
        ...
        priors: {
          ...
          register: { mid: 80, high: 20 },
          motion: { sustained: 25, walking: 55, flowing: 20 },
          accompaniment: { sustained: 20, broken: 20, pulse: 60 },
      ...
      // Processional cues and hymn-like cues.
      {
        ...
        priors: {
          ...
          motion: { sustained: 65, walking: 35 },
          accompaniment: { sustained: 50, pulse: 50 },
      ...
      // Sparse drones and held colour.
      {
        ...
        priors: {
          ...
          register: { low: 50, mid: 15, high: 35 },
          motion: { sustained: 65, flowing: 35 },
          accompaniment: { broken: 35, pulse: 65 },
      ...
      // Crescendo drama, action cues.
      {
        ...
        priors: {
          ...
          register: { mid: 60, high: 40 },
          motion: { sustained: 25, walking: 35, flowing: 40 },
          accompaniment: { broken: 20, pulse: 80 },
      ...
      // Uneasy cues that keep adding weight.
      {
        ...
        priors: {
          ...
          motion: { sustained: 65, walking: 15, flowing: 20 },
