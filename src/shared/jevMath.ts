// Shared stub arithmetic for the inbox and match demos.
// Same idea as the music/trolley HeuristicPlanner: calibrated-looking
// numbers, no network, so the pages work offline.
